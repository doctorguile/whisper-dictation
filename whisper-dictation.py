...
def parse_args():
    ...
    parser.add_argument('-k', '--key_combination', type=str,
                        ...
                        'ctrl+alt for other platforms. Default: cmd_l+alt (macOS) or ctrl+alt (others).')
    parser.add_argument('--k_double_cmd', action='store_true', default=True,
...
if __name__ == "__main__":
    ...
    if args.key_combination:
        key_listener = GlobalKeyListener(app, args.key_combination)
    elif args.k_double_cmd:
        key_listener = DoubleCommandKeyListener(app)
    else:
        raise ValueError('Please specify a key combination or use double_cmd')
